...
public class GlobalErrorController extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleProductNotFound(TaskNotFoundException ex) {
        ...
        result.setType(URI.create("https://www.taskapp.com/errors/task-not-found"));
        return result;
    }
    ...
    public ProblemDetail handleAuthException(AuthenticationException ex) {
        ...
        result.setType(URI.create("https://www.taskapp.com/errors/authentication"));
        return result;
    }
    ...
    public ProblemDetail handleAccessDeniedException(AccessDeniedException ex) {
        ...
        result.setType(URI.create("https://www.taskapp.com/errors/authorization"));
        return result;
    }
